...
public class jamesmod {
    ...
    public static final String MODID = "jamesmod";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();
    // Create a Deferred Register to hold Blocks which will all be registered under the "jamesmod" namespace
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(MODID);
    // Create a Deferred Register to hold Items which will all be registered under the "jamesmod" namespace
    ...
    public static final DeferredBlock<Block> CTRLALTCODE_BLOCK = BLOCKS.registerSimpleBlock("ctrlaltcode_block",
        BlockBehaviour.Properties.of()
            ...
            .strength(5.0f, 6.0f) // Hardness and resistance (similar to iron block)
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CTRLALTCODE_TAB = CREATIVE_MODE_TABS.register("ctrlaltcode_tab", () -> CreativeModeTab.builder()
            ...
            .withTabsBefore(CreativeModeTabs.COMBAT)
            .icon(() -> CTRLALTCODE_BLOCK_ITEM.get().getDefaultInstance()) // Use the CtrlAltCode block as the tab icon
            .displayItems((parameters, output) -> {
