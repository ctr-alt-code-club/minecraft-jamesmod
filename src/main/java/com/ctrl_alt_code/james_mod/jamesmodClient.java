...
@Mod(value = jamesmod.MODID, dist = Dist.CLIENT)
// You can use EventBusSubscriber to automatically register all static methods in the class annotated with @SubscribeEvent
@EventBusSubscriber(modid = jamesmod.MODID, value = Dist.CLIENT)
public class jamesmodClient {
    public jamesmodClient(ModContainer container) {
